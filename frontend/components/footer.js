class CustomFooter extends HTMLElement {
    connectedCallback() {
        ...
        this.shadowRoot.innerHTML = `
            ...
            <div class="footer-container">
                <div class="footer-grid">
                    <div>
                        <div class="footer-logo">
                            <div class="footer-logo-icon">EG</div>
                            <div class="footer-logo-text">EduGlow</div>
                        </div>
                    ...
                    <div>
                        ...
                        <div class="footer-links">
                            ...
                            <a href="safety.html" class="footer-link">Safety</a>
                ...
                <div class="footer-bottom">
                    <p class="copyright">
                        &copy; <span id="current-year"></span> EduGlow. All rights reserved.
                    </p>
        ...
        const yearNode = this.shadowRoot.getElementById('current-year');
        if (yearNode) {
